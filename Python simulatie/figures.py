...
m1 = [(0,0.75),(0.05,0.9),(0.1,0.75)]
m2 = [(0.1,0.75),(0.2,0.5),(0.2,1)]
m3 = [(0.2,1),(0.25,0.35),(0.3,1)]
m4 = [(0.3,1),(0.35,0.35),(0.4,0.75)]
m5 = [(0.4,0.75),(0.45,0.9),(0.5,0.75)]

letter_m = [m1, m2, m3, m4]
